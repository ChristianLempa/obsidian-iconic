...
export const DEVICONS: IconDefinition[] = [
	...
	},
	{
		id: 'vuejs',
		name: 'Vue.js',
		svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"><path fill="#4FC08D" d="M0 21.4 64 106.6 128 21.4H102L64 78.1 26 21.4H0z"/><path fill="#35495E" d="M26 21.4 64 78.1 102 21.4H81.4L64 48.5 46.6 21.4H26z"/></svg>'
	},
	{
		id: 'angular',
		name: 'Angular',
		svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"><path fill="#DD0031" d="M64 0 6.4 21.3 0 106.7l64 21.3 64-21.3-6.4-85.4L64 0zm0 13.3 48 16v74.7L64 115.2 16 104v-74.7l48-16z"/><path fill="#fff" d="M64 21.3 24 96h13.3l6.7-16h32l6.7 16H104L64 21.3zm0 22.7 12 29.3H52l12-29.3z"/></svg>'
	}
];
...
export const SELFHOST_ICONS: IconDefinition[] = [
	...
	},
	{
		id: 'sonarr',
		name: 'Sonarr',
		svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#00A4DC" d="M256 0C114.6 0 0 114.6 0 256s114.6 256 256 256 256-114.6 256-256S397.4 0 256 0zm0 64c106 0 192 86 192 192s-86 192-192 192S64 362 64 256 150 64 256 64zm-64 96v192l64-48 64 48V160l-64 48-64-48z"/></svg>'
	},
	{
		id: 'radarr',
		name: 'Radarr',
		svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#FF6B6B" d="M256 32L32 96v320l224 64 224-64V96L256 32zm0 64l160 45.7v230.6L256 416l-160-43.7V141.7L256 96zM160 192v128l96-64-96-64z"/></svg>'
	},
	{
		id: 'traefik',
		name: 'Traefik',
		svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="#24A1C1" d="M256 32l-224 80v288l224 80 224-80V112L256 32zm0 64l160 57v190l-160 57-160-57V153l160-57zM192 192h128v128H192V192z"/></svg>'
	}
];
